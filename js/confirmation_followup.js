...
function confirmationTableOnClick() {
    ...
    $('.loan-history, .doc-history').off('click').click(function () {
        ...
        historyTableContents(cus_id, type)
    });
...
function historyTableContents(cus_id, type) {

    if (type == 'loan-history') {

        //for loan history
        $('.loan-history-card, #close_history_card').show();
        $('.doc-history-card, .conf-list-card').hide();//loan followup list 
        ...
        $('.doc-history-card, #close_history_card').show();
        $('.loan-history-card, .conf-list-card').hide();
