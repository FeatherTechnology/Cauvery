$(document).ready(function () {
    ...
    $('#search_cus').click(function (event) {
        ...
        let autogen_cus_id = $('#autogen_cus_id').val(); let first_name = $('#first_name').val(); let last_name = $('#last_name').val(); let mobile = $('#mobile').val(); let loan_id = $('#loan_id').val();
        if (!validate()) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'JSON',
                data: { cus_id, autogen_cus_id, first_name, last_name, mobile, loan_id },
...
function validate() {
    ...
    if (cus_id == '' && autogen_cus_id == '' && first_name == '' && last_name == '' && mobile == '' && loan_id == '') {
        response = false;
