$(document).ready(function () {
    ...
    $('#reset_btn').click(function () {
        ...
        resetAllTables()
        // Load data
        verificationReportCount(from_date, to_date, selected_user);
...
function getUserNames() {
    $.post('reportFile/due_followup_count_report/getDuefollowupUser.php', { screen : 4 }, function (response) {
         $('#by_user').empty()
...
function verificationReportCount(from_date, to_date, selected_user) {
