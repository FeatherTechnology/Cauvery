...
<table class="table custom-table " id="fam_datacheck">
    ...
    <tbody>
        ...
        $cusInfo = $connect->query("SELECT CONCAT(a.first_name, ' ', a.last_name) AS famname,a.`relationship`,a.`relation_aadhar`,rc.`cus_id`,CONCAT(rc.first_name, ' ', rc.last_name) AS customer_name FROM `verification_family_info` a left join `request_creation` rc 
