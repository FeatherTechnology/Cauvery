...
if ($userid == 1) {
    $query = "SELECT rc.req_id, rc.cus_id, cr.autogen_cus_id, CONCAT(rc.first_name,' ', rc.last_name) AS cus_name, rc.mobile1, cr.area_confirm_area AS area, rc.cus_status, rc.cus_data, cr.area_group, cr.area_line 
