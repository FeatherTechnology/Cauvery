...
$query = "SELECT cc.*,CONCAT(cc.first_name, ' ', cc.last_name) AS cus_name,sc.staff_name,cs.concern_subject,stc.staff_type_name,ag.ag_name,u.fullname,ag.ag_code,cc.pass_to,cdn.dep_name
