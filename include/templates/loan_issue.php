									...
									<div class="row">
										...
										<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
											<div class="form-group">
												...
												<button type="button" class='btn btn-success scan_btn' style='background-color: #0C70AB;margin-top: 19px;' onclick="event.preventDefault()" title='Put Your Thumb' tabindex='58'><i class="material-icons" id="icon-flipped"> &#xe90d; </i>&nbsp;Scan</button>
