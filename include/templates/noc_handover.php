							...
							<div class="row">
								<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="noc_date" name="noc_date" value='<?php echo date('d-m-Y'); ?>' readonly tabindex='40'>
									</div>
								</div>
								<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
									<div class="form-group">
								...
								<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mem_relation_name">
									<div class="form-group">
										...
										<select type='text' id='mem_relation_name' name='mem_relation_name' class="form-control" tabindex='42'>
								...
								<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 scan_btn">
									<div class="form-group">
										...
										<button type="button" class='btn btn-success noc_scan_btn'   style='background-color:#0C70AB;margin-top: -50px;width: auto;' onclick="event.preventDefault()" title='Put Your Thumb' tabindex='44'><i class="material-icons" id="icon-flipped">&#xe90d;</i>&nbsp;Scan</button> 
