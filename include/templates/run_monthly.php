<?php
include 'C:/xampp/htdocs/Cauvery/ajaxconfig.php';
...
foreach ($chunks as $chunk) {
    ...
    foreach ($chunk as $req_id) {
        ...
        $ch = curl_init('http://localhost/Cauvery/collectionFile/resetCustomerStatus.php');
        ...
        if (!empty($response) && isset($response['req_id'])) {
            ...
            $ch2 = curl_init('http://localhost/Cauvery/updateCustomerStatusFile/updateCustomerStatus.php');
