                            ...
                            <div class="row" id="customer" style="display: none;"> <!-- When Raising For is customer Means customer will show -->
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="last_name" name="last_name" tabindex='7' readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="cus_area" name="cus_area" readonly tabindex='8'>
                                    </div>
                                </div>
