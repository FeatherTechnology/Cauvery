...
SELECT * FROM (
    ...
    WHERE DATE(cdb.updated_date) BETWEEN '$from_date' AND '$to_date'" . ($user_based != "" ? " AND cdb.insert_login_id = '$userid'" : "") . "
    ...
    WHERE DATE(ccb.updated_date) BETWEEN '$from_date' AND '$to_date'" . ($user_based != "" ? " AND ccb.insert_login_id = '$userid'" : "") . "
) AS sub
";
