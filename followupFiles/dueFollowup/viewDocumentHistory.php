...
<table class="table custom-table" id='DocHistTable'>
    ...
    <tbody>
        ...
        $run = $connect->query("SELECT lc.due_start_from,CONCAT(lc.first_name, ' ', lc.last_name) AS customer_name,lc.loan_category,lc.loan_amt_cal,lc.due_amt_cal,lc.net_cash_cal,lc.collection_method,ii.loan_id,ii.req_id,ii.updated_date,ii.cus_status, rc.agent_id,lcc.loan_category_creation_name as loan_catrgory_name, us.collection_access, cs.sub_status
...
<script>
    ...
    initColVisFeatures(DocHistTable, 'DocHistTable');
</script>
