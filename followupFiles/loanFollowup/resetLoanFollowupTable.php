...
$sql = "( SELECT rc.updated_date, rc.cus_id, cr.autogen_cus_id, rc.cus_name, alc.area_name, salc.sub_area_name, lcc.loan_category_creation_name, ac.ag_name, bc.branch_name, agm.group_name, alm.line_name, rc.req_id, rc.cus_status 
...
UNION ALL
(
    SELECT rc.updated_date, cp.cus_id, cr.autogen_cus_id, cp.cus_name, alc.area_name, salc.sub_area_name, lcc.loan_category_creation_name, ac.ag_name, bc.branch_name, agm.group_name, alm.line_name, rc.req_id, rc.cus_status 
    FROM request_creation rc 
    JOIN customer_register cr ON rc.cus_id = cr.cus_id
