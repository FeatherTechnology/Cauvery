...
foreach ($result as $row) {
    ...
    $data[] = [
        ...
        $row['mobile1'],
        $row['mobile2'],
        "<a href='due_followup&upd={$row['req_id']}&cusidupd={$cus_id}&cummDate={$commdate_val}&res_sts={$res_sts_val}&comm_sts={$comm_sts_val}' title='Edit details'><button class='btn btn-success' style='background-color:#0C70AB;'>View Loans</button></a>",
