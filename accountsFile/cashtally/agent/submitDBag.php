...
/* ✅ INSERT AGENT DEBIT */
$qry = $connect->query(" INSERT INTO ct_db_bag (ag_id, bank_id, ref_code, trans_id, remark, amt, insert_login_id, created_date)
    VALUES
    ('$ag_id','$bank_id','$ref_code','$trans_id','$remark','$amt','$user_id','$op_date')");
