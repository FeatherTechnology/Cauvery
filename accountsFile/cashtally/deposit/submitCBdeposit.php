...
$chk = $connect->query(" SELECT transaction_amount  FROM bank_stmt 
    WHERE bank_id = '$bank_id' AND trans_id = '$trans_id' AND $sts > 0 ")->fetch(PDO::FETCH_ASSOC);
...
$qry = $connect->query("
    INSERT INTO ct_cr_bdeposit (bank_id, ref_code, trans_id, name_id, area, ident, remark, amt, insert_login_id, created_date)
    VALUES
